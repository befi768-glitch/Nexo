...
export const FOREST_EVENT = {
  ...
  choices: [
    {
      id: "help",
      label: "❤️ Giúp người đó",
      result: "Bạn đã cứu người lạ. Anh ta ghi nhớ lòng tốt của bạn.",
      coin: 30,
      reputation: 5
    },
    {
      id: "search",
      label: "💰 Lục túi của người đó",
      result: "Bạn tìm thấy vài đồng coin, nhưng hành động này để lại tiếng xấu.",
      coin: 100,
      reputation: -8
    },
    {
      id: "leave",
      label: "🚶 Bỏ đi",
      result: "Bạn tiếp tục hành trình. Chuyện gì xảy ra với người đó vẫn là một bí ẩn.",
      coin: 0,
      reputation: 0
    }
  ]
